...
namespace ScriptEditor
{
	...
	public static class SaveCharaBin_Util
	{
		...
		public static void SaveBinListScript ( BinaryWriter bw, Chara chara, List < Script > lsScp, Compend cmp )
		{
			//スクリプト個数
...
//				Debug.Write ( "" + scp.Group + ",");
		...
		//---------------------------------------------------------------------
		//ScriptParam_Battle
		public static void SaveBinScrPrmBtl ( BinaryWriter bw, Script scp )
		{
...
//			int i = (int)prm.CalcState ;
		...
		//---------------------------------------------------------------------
		//ScriptParam_Staging
		public static void SaveBinScrPrmStg ( BinaryWriter bw, Script scp )
		{
