...
namespace Chara050
{
    ...
    {
        public Compend behavior = new Compend ();   //アクションの集合
        public Compend garnish = new Compend ();    //エフェクトの集合
        ...
        public BD_T BD_SE { get; } = new BD_T ();     //SEリスト
		public BD_T BD_VC { get; } = new BD_T ();     //VCリスト
