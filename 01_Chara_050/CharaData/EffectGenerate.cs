...
namespace Chara050
{
	...
	public class EffectGenerate : IName
	{
		...
		//ループ
		public int Loop { get; set; } = 1;	//ループ (回数,0は無限)
		//ループ時強制終了
		...
		public Point Rotate_Center = new Point ( 0, 0 );	//回転の中心


		//終了時(通常、相殺、ヒット、ガード)、次のエフェクト (""空文字列は終了して破棄)
		public string NextEfName = "";
